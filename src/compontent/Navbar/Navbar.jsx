    ...
    <>
      <nav className=" border-gray-200  bg-white shadow">
        <div className="max-w-screen-xl flex  md:flex-nowrap  flex-wrap items-center justify-between  mx-auto p-4">
          ...
          <Link
            to="/"
            className="flex items-center space-x-11 rtl:space-x-reverse"
          >
         ...
         <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white  ">
            ...
            <ul className="font-medium flex flex-col ms-auto  p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white  ">
              <li>
              ...
              <>
                ...
                <li>
                   <span className="block py-2 px-1">Hello {userData?.name}</span>
                </li>

                <li className="relative text-main">
                   <span className="block py-2 px-1 ">
                     <i class="fa-solid fa-cart-shopping"></i>
                     <span className=" absolute top-0 end-0 translate-x-2">{numsCartItems}</span>
                   </span>
                </li>
